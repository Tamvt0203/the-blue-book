- Exercis e8.1: Modify clock2 to accept a port number, and write a program, clockwall, that
...
- Exercis e8.3: In netcat3, the interface value conn has the concrete typ e *net.TCPConn, which
...
- Exercis e8.4: Modify the reverb2 server to use a sync.WaitGroup per connection to count
